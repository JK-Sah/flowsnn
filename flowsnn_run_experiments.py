...
==========================
Run the 3-seed FlowSNN experiments described in the Ocean Engineering manuscript.
...
-----
    ...
    python flowsnn_run_experiments.py --resume     # skip already-completed experiments

Output
------
    flowsnn_results.json  – all metrics (accuracy, heading MAE, speed MAE, energy)
    After it finishes, share the JSON with Claude so the manuscript can be updated.
