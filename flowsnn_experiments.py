"""
FlowSNN experiments — corrected NumPy/SciPy implementation.
Bugs fixed vs v1:
  - SNN forward: added hard reset (U[t] -= thresh*S[t-1])
  - SNN BPTT: correct formula g=(d + (-thresh)*g)*surr + beta*g
  - CNN: correct sliding_window_view usage
"""
import numpy as np
